        ...
        <template slot="expand" scope="props">
            <v-card class="elevation-10">
                ...
                <v-card-actions>
                    <v-layout row wrap>
                        <v-flex xs6>
                            <v-text-field type="number" v-model="numberOfOrder" min="1" max="`${props.item.quantite}`" label="Quantité" outline></v-text-field>
                        </v-flex>
                        <v-flex xs6>
                            <div class="text-xs-center align-center">
                                <v-btn flat @click="removeOrder(props.item, numberOfOrder)" outline color="indigo">Enlever</v-btn>
                            </div>
                        </v-flex>
                    </v-layout>
                </v-card-actions>
